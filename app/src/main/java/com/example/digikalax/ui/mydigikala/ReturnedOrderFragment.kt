...
import com.example.digikalax.databinding.FragmentReturnedOrderBinding
...
@AndroidEntryPoint
class ReturnedOrderFragment : Fragment() {


  lateinit var binding: FragmentReturnedOrderBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentReturnedOrderBinding.inflate(inflater,container,false)
        return binding.root
    }
