...
class UserCommentsAdapter@Inject constructor(@ApplicationContext val context: Context):RecyclerView.Adapter<UserCommentsAdapter.UserCommentViewHolder>() {

    lateinit var binding: ItemNazaratBinding



    var itemsShowCase= emptyList<ResponseGetUserComments.Data>()


    inner class UserCommentViewHolder(item: View):RecyclerView.ViewHolder(item){



        fun onBind(item:ResponseGetUserComments.Data){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserCommentViewHolder {
        ...
        return UserCommentViewHolder(binding.root)
    }
    ...
    fun setData(data: List<ResponseGetUserComments.Data>) {

        val diffUtiles = DiffUtilsssss(itemsShowCase, data)
...
class DiffUtilsssss(
    private val oldItem: List<ResponseGetUserComments.Data>,
    private val newItem: List<ResponseGetUserComments.Data>
) : DiffUtil.Callback() {
