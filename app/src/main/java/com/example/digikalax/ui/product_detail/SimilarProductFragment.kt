...
import com.example.digikalax.databinding.FragmentSimilarProductBinding
...
class SimilarProductFragment : Fragment() {
    ...
    lateinit var binding: FragmentSimilarProductBinding
...
var isExistInDatabase=false
    ...
    private val args by navArgs<SimilarProductFragmentArgs>()
    ...
    override fun onCreateView(
        ...
        binding= FragmentSimilarProductBinding.inflate(inflater,container,false)
        return binding.root
    }
                        ...
                        is NetworkRequest.Success -> {
                            ...
                            response.data?.data?.let { data ->
                                ...
                                if (data.comments.isNotEmpty()) {
                                    ...
                                    binding.didgahCount.text =
                                        "${data.commentCount.toString()} نفر "
                                ...
                                binding.productPrice.text =
                                    " تومان${decimalFormatter.format(data.price)}"
